...
<div class="form-container">
	...
	<form class="form" action="Reg.jsp" method="post" >
			<div class="input-group">
			<label for="username">User Id</label>
			<input type="text" name="userid" id="username" placeholder="">
		</div>
		<div class="input-group">
		...
		<input class="sign" type="submit" value="Sign Up" ></input>
	</form>
	...
	<p class="signup">Have an account?
		<a rel="noopener noreferrer" href="Login.jsp" class="">Log in</a>
	</p>
</div>
    <div class="contact">
      <div class="details">
...
try{
	...
	User.Connect();
    User.st.execute("insert into users values("+id+",'"+name+"', '"+email+"', '"+pw+"')");
	User.st.close();
	User.con.close();
